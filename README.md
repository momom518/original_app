...
<h1>今後実装したい機能</h1>
<p>●明日のセール情報欄を追加●</p>
<p>日付間違いを防ぐために、今日のセール情報だけを表示しているが、別ページに翌日のセール情報だけをまとめたものを表示できるようにした方が、翌日の情報もわかりユーザーのニーズにより答えられると思ったため。</p>
<p>●検索機能●</p>
<p>商品名でセール情報を検索できる方がより、ユーザーにとって使いやすいため。</p>
<p●>管理者の権限レベルを追加●</p>
<p>管理者レベルを考慮して、それに応じてできることを制限したい。具体的には、セール情報の操作は権限の低い人間でも行えるが、店情報を操作できるのはより上位の権限を持っている者だけが行えるようにしたい。これは、より現実に近づけるためである。セール情報を投稿するのはおそらく責任者ではなく、一般のスタッフであると考えられ、頻繁に投稿・削除される可能性が高いので、権限の低い人間にも行えるようにしたい。反対に、店の情報は頻繁にかわるものではなく簡単に変更できないようにした方が情報の信頼性を担保できると考えられるため。</p>
<p>●AWSへのデプロイ●<p>
<p>herokuでは画像が一定時間経過により削除されてしまうので、せっかくの画像が消えてしまうと購買意欲にも影響がでると考えたため。</p>
